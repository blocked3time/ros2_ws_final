...
{
    static cv::VideoWriter writer2("video.mp4", cv::VideoWriter::fourcc('a', 'v', 'c', '1'), 30, cv::Size(640, 360), true);
    if(!writer2.isOpened()) { RCLCPP_ERROR(node->get_logger(), "Writer2 open failed!"); rclcpp::shutdown(); }
